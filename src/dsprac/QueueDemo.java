...
public class QueueDemo {
  ...
  public void insert(String input) {
    if (numberOfItems + 1 <= queueSize) {
      // Check to see if Rear and Front are not at end of Queue,
      // if they are then simply reset them to starting position.
  ...
  public static void main(String[] args) {
    ...
    QueueDemo theQueue = new QueueDemo(10);
    ...
    // Remove the element at First position in Queue.
    theQueue.remove();
