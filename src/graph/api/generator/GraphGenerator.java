...
public class GraphGenerator {
	 ...
	 * @return a random simple graph on <tt>V</tt> vertices, with an edge
	 *         between any two vertices with probability <tt>p</tt>
	 * @throws IllegalArgumentException
	 ...
	 * @return a complete bipartite graph on <tt>V1</tt> and <tt>V2</tt>
	 *         vertices
	 * @throws IllegalArgumentException
	 *             if probability is not between 0 and 1
	 */
	 ...
	 * @param E
	 *            the number of edges
	 * @return a random simple bipartite graph on <tt>V1</tt> and <tt>V2</tt>
	 *         vertices, containing a total of <tt>E</tt> edges
	 * @throws IllegalArgumentException
	 ...
	 *         to every vertex in a cycle on <tt>V-1</tt> vertices
	 */
