 ...
 * <li> {@link #setScale(double getMin, double max)}
 * </ul>
 *
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * @throws IllegalArgumentException if {@code (max == getMin)}
     */
    public static void setXscale(double min, double max) {
        double size = max - min;
        if (size == 0.0) throw new IllegalArgumentException("the getMin and max are the same");
