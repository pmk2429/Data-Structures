...
/**
 * This class implements the Dual-Pivot Quicksort algorithm. The algorithm
 * offers O(n log(n)) performance on many data sets that cause other quicksorts
 * to degrade to quadratic performance, and is typically faster than traditional
...
final class DualPivotQuicksort {
	 ...
	 * {@code sort} method in that the {@code right} index is inclusive, it does
	 * no range checking on {@code left} or {@code right}, and has boolean flag
	 * whether insertion sort with sentinel is used or not.
	 *
	 * @param a
	 *            the array to be sorted
	 * @param left
	 ...
	 * @param leftmost
	 *            indicates if the part is the most left in the range
	 */
