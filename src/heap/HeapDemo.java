...
public class HeapDemo<AnyType extends Comparable<AnyType>> {
	...
	public static void main(String[] args) {
		HeapDemo<String> h = new HeapDemo<String>();
		...
		HeapDemo<Integer> tmp = new HeapDemo<Integer>();
